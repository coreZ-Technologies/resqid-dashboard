...
export default function SubjectFilters({ search, onSearchChange, categoryFilter, onCategoryChange, statusFilter, onStatusChange }) {
    return (
            ...
            <div className="flex gap-1.5 flex-wrap">
                {SUBJECT_CATEGORIES.map(cat => (
                    <button
                        ...
                        className={`px-3 py-2 rounded-lg border text-sm font-medium transition-all ${categoryFilter === cat
            ...
            <div className="flex gap-1.5">
                {["All", "Active", "Inactive"].map(s => (
                    <button
                        ...
                        className={`px-3 py-2 rounded-lg border text-sm font-medium transition-all ${statusFilter === s
