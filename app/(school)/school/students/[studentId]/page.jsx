...
function ContactCard({ contact, onCall, onWhatsApp }) {
    return (
        <div className="flex items-center gap-3 p-3 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center text-blue-700 font-semibold">
...
function EmergencyProfileCard({ student, onToggleVisibility }) {
    const visibilityConfig = {
        PUBLIC: { label: 'Full Visibility', color: 'green', icon: Eye, description: 'All emergency contacts and medical info are visible' },
        MINIMAL: { label: 'Minimal Profile', color: 'amber', icon: EyeOff, description: 'Only primary contact is visible' },
        HIDDEN: { label: 'Hidden Profile', color: 'red', icon: Lock, description: 'No emergency info is visible when scanned' },
    };
            ...
            <div className="p-4 border-b border-slate-200 bg-gradient-to-r from-red-50 to-orange-50">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-semibold text-slate-800">Emergency QR Profile</h3>
                    </div>
                    <button
                        onClick={onToggleVisibility}
                        className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium text-slate-600 hover:bg-white transition-colors"
                    >
            ...
            <div className="p-4">
                <div className="bg-slate-50 rounded-lg p-3 mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <button className="text-xs text-blue-600 hover:underline mt-1">Download QR Code</button>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-3">
                    <div className="flex justify-between items-center py-2 border-b border-slate-100">
                        ...
                        <span className="font-mono font-bold text-red-600">{student.medicalInfo.bloodGroup}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-slate-100">
                    ...
                    <div className="flex justify-between items-center py-2">
                        ...
                        <span className="text-sm text-slate-700">2024-12-20 10:30 AM</span>
                    </div>
                </div>

                <button className="w-full mt-4 py-2 rounded-lg bg-blue-600 text-white text-sm font-medium hover:bg-blue-700 transition-colors flex items-center justify-center gap-2">
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
                ...
                <div className="text-center p-3 bg-red-50 rounded-lg">
                    <p className="text-2xl font-bold text-red-600">{attendance.total - attendance.present}</p>
                ...
                <div className="w-full h-2 bg-slate-200 rounded-full overflow-hidden">
                    <div
                        className={cn(
                            ...
                            attendance.percentage >= 75 ? "bg-green-500" : attendance.percentage >= 60 ? "bg-amber-500" : "bg-red-500"
                        )}
            ...
            {/* Monthly Breakdown */}
            <div>
                <p className="text-sm font-medium text-slate-700 mb-3">Monthly Breakdown</p>
                    ...
                    <div className="space-y-2">
                        {attendance.recentAbsences.map((absence, idx) => (
                            <div key={idx} className="flex justify-between items-center text-sm p-2 bg-slate-50 rounded-lg">
                                <div>
                                    <p className="text-slate-700">{new Date(absence.date).toLocaleDateString()}</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        <div className="bg-white rounded-xl border border-slate-200 p-4">
                            <div className="flex items-center justify-between mb-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="font-semibold text-slate-800">Parents & Guardians</h3>
                                </div>
                                <button className="text-xs text-blue-600 hover:underline">Add Contact</button>
                            </div>
                            <div className="space-y-3">
                        ...
                        <div className="bg-white rounded-xl border border-slate-200 p-4">
                            ...
                            <div className="space-y-2">
                                <button className="w-full flex items-center gap-2 p-2 rounded-lg hover:bg-slate-50 text-slate-700 transition-colors">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                                    ...
                                    <div className="space-y-3">
                                        {student.recentActivity.map((activity, idx) => (
                                            <div key={idx} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                                ...
                                                <span className="text-xs text-green-600 bg-green-50 px-2 py-1 rounded">{activity.status}</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                        ...
                        {activeTab === 'academic' && (
                            <>
                                ...
                                <div className="bg-white rounded-xl border border-slate-200 p-4">
                                    <h3 className="font-semibold text-slate-800 mb-4">Academic Achievements</h3>
                                    <div className="space-y-2">
                                    ...
                                    {student.academicInfo.remarks && (
                                        <div className="mt-4 p-3 bg-amber-50 rounded-lg">
                                            ...
                                            <p className="text-sm text-slate-700">{student.academicInfo.remarks}</p>
                                        </div>
                                    )}
                                </div>
                            </>
                            ...
                            <>
                                <div className="bg-white rounded-xl border border-slate-200 p-4">
                                    ...
                                    <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                                        <p className="text-sm text-red-700">{student.medicalInfo.emergencyInstructions}</p>
                                    </div>
                                </div>

                                <div className="bg-white rounded-xl border border-slate-200 p-4">
                                    <h3 className="font-semibold text-slate-800 mb-4">Emergency Contacts - Full List</h3>
                                    <div className="space-y-3">
                        ...
                        {activeTab === 'medical' && (
                            <>
                                    ...
                                    <div className="space-y-4">
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <p className="text-lg font-bold text-red-600">{student.medicalInfo.bloodGroup}</p>
                                            </div>
                                            <div>
                                                <p className="text-xs text-slate-400">Last Checkup</p>
                                                <p className="text-sm text-slate-700">{new Date(student.medicalInfo.lastCheckup).toLocaleDateString()}</p>
                                            </div>
                                        </div>
                                ...
                                <div className="bg-white rounded-xl border border-slate-200 p-4">
                                    <h3 className="font-semibold text-slate-800 mb-4">Doctor Information</h3>
                                    <div className="space-y-3">
                                ...
                                <div className="bg-white rounded-xl border border-slate-200 p-4">
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between py-2 border-b border-slate-100">
                                            ...
                                            <span className="text-sm font-medium text-slate-700">{student.medicalInfo.insurance.provider}</span>
                                        </div>
                                        <div className="flex justify-between py-2 border-b border-slate-100">
                                            <span className="text-sm text-slate-500">Policy Number</span>
                                            <span className="text-sm font-medium text-slate-700">{student.medicalInfo.insurance.policyNumber}</span>
                                        </div>
                                        <div className="flex justify-between py-2">
                                            <span className="text-sm text-slate-500">Valid Until</span>
                                            <span className="text-sm font-medium text-slate-700">{new Date(student.medicalInfo.insurance.validUntil).toLocaleDateString()}</span>
                                        </div>
                                    </div>
                                </div>
                            </>
                        ...
                        {activeTab === 'documents' && (
                            <div className="bg-white rounded-xl border border-slate-200 p-4">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-blue-600 text-white text-sm hover:bg-blue-700 transition-colors">
                                        <Plus size={14} />
                                        Upload Document
                                    </button>
                                </div>
                                        ...
                                        <div key={doc.id} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-400">{doc.type} • {doc.size} • Uploaded {new Date(doc.uploadedAt).toLocaleDateString()}</p>
                                                </div>
                                            </div>
